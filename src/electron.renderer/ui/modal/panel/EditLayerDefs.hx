...
class EditLayerDefs extends ui.modal.Panel {
	...
	public function new() {
		...
		loadTemplate( "editLayerDefs", "defEditor editLayerDefs",  {
			...
			projectLayersTitle: L.t._("Project layers"),
			layersHelpText: L.t._("Each LEVEL in your project has LAYERS, as defined below. The layers content can be of various types, including Image Tiles or Integer values."),
			generalSettingsCollapser: L.t._("General layer settings"),
			typeLabel: L.t._("Type"),
			tileLayerTutorialBtn: L.t._("Tile layer tutorial"),
			autoLayerTutorialBtn: L.t._("Auto-layer tutorial"),
			layerIdentifierLabel: L.t._("Layer identifier"),
			documentationLabel: L.t._("Documentation"),
			defaultTilesetLabel: L.t._("Default tileset"),
			defaultTilesetInfo: L.t._("Default tileset used by this layer. It can be changed in each level from the left tool panel."),
			createNewTilesetBtn: L.t._("Create new tileset"),
			gridSizeLabel: L.t._("Grid size"),
			gridSizeInfo: L.t._("Snap grid dimensions in pixels."),
			offsetsLabel: L.t._("Offsets"),
			offsetsInfo: L.t._("The offset is used to adjust the horizontal and vertical position of this layer relatively to the level and the other layers.\n\t\t\t\tEach offset can be negative or positive."),
			opacityLabel: L.t._("Opacity"),
			opacityInfo: L.t._("Opacity of this layer in percentage, from 0 (transparent) to 100 (fully visible).\n\t\t\t\tThe \"inactive\" opacity is used when the layer is not being selected."),
			baseLabel: L.t._("Base:"),
			inactiveLabel: L.t._("Inactive:"),
			parallaxLabel: L.t._("Parallax"),
			parallaxInfo: L.t._("These parallax factors are applied to the layer (coordinates and scale) to make it move \"slower\" or \"faster\" than the camera, creating a fake 3D depth effect.\n\t\t\t\t- Greater than zero factor will make the layer movement slower than the camera (eg. mountains in a far background).\n\t\t\t\t- Zero means the layer moves at the same rate as the camera.\n\t\t\t\t- Less than zero means the layer moves faster than the camera (eg. fog in the foreground)"),
			scaleLabel: L.t._("Scale ?"),
			displayOptionsCollapser: L.t._("Display options"),
			colorInLayersListLabel: L.t._("Color in layers list"),
			colorInLayersListInfo: L.t._("This color will be used in all lists where the layer appears."),
			visualOptionsLabel: L.t._("Visual options"),
			hideInListLabel: L.t._("Hide in list"),
			showInWorldViewLabel: L.t._("Show in world view"),
			allowSelectionsLabel: L.t._("Allow selections when inactive"),
			asyncRenderLabel: L.t._("Asynchronous render"),
			guideGridLabel: L.t._("Optional \"guide\" grid"),
			guideGridInfo: L.t._("Dimensions of the optional secondary grid. This grid is only a visual guide and is not used for actual snapping like the normal one."),
			uiTagsLabel: L.t._("UI tags"),
			uiTagsInfo: L.t._("These tags are used to filter elements from your layer list in the main editor panel."),
			settingsCollapserSuffix: L.t._(" settings"),
			hideFieldsLabel: L.t._("Hide entity fields when inactive"),
			hideFieldsInfo: L.t._("If enabled, entity fields will not be shown if the layer is not currently selected."),
			valuesIconsLabel: L.t._("Values interface icons"),
			valuesIconsInfo: L.t._("You may associate custom interface icons to each value. These icons are only used for the UI, not for actual rendering. To render values as tiles in your level, use Auto-Layer below."),
			gridValuesLabel: L.t._("Grid values"),
			gridValuesInfo: L.t._("The list of all Integer values that could be painted in this IntGrid layer."),
			tilePivotLabel: L.t._("Tile pivot point"),
			tilePivotInfo: L.t._("This is only useful if the Tileset grid size is different from the layer grid size.\n\t\t\t\tIn this case, the pivot will dictate the position of the tiles relatively to the layer grid."),
			autoLayerSourceLabel: L.t._("Auto-Layer source"),
			autoLayerSourceHelp: L.t._("This auto-layer will use the INTGRID layer above to apply its rules."),
			autoLayerTilesetLabel: L.t._("Auto-layer tileset"),
			autoLayerTilesetInfo: L.t._("Selecting a Tileset here will enable all Auto-Layer rendering capabilities for this layer.\n\t\t\t\tThis allows to render automatically tiles based on the IntGrid values (eg. painting random \"grass\" tiles above cells containing \"collision\" values)."),
			editRulesBtn: L.t._("Edit rules"),
			killTilesLabel: L.t._("Kill tiles"),
			killTilesInfo: L.t._("If the selected Tile layer contains any tiles, this auto-layer won't draw anything under them."),
			biomeEnumLabel: L.t._("Biome enum"),
			biomeEnumInfo: L.t._("You can use an Enum field from your level custom fields as a \"biome selector\".\n\t\t\t\tAuto-layer rule groups may then be individually enabled when a certain biome is picked."),
			requiredTagsLabel: L.t._("Required tags"),
			requiredTagsInfo: L.t._("Only entities that have at least ONE of the required tags will be allowed in this layer.\n\t\t\t\tNote: this won't affect previously added entities."),
			excludedTagsLabel: L.t._("Excluded tags"),
			excludedTagsInfo: L.t._("Entities that have at least ONE of the forbidden tags will not be allowed in this layer.\n\t\t\t\tNote: this won't affect previously added entities."),
			advancedOpsLabel: L.t._("Advanced operations"),
			moveEntitiesBtn: L.t._("Move existing entities to another layer"),
			bakeAutoLayerBtn: L.t._("Bake auto-layer"),
		} );
