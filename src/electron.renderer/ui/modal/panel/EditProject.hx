...
class EditProject extends ui.modal.Panel {
	...
	public function new() {
		...
		loadTemplate("editProject", "editProject", {
			...
			projectSettingsTitle: L.t._("Project settings"),
			saveProjectBtn: L.t._("Save project"),
			saveAsBtn: L.t._("Save as..."),
			renameProjectBtn: L.t._("Rename project"),
			extraFilesHeader: L.t._("Extra files"),
			superSimpleExportLabel: L.t._("Super simple export ❤"),
			superSimpleExportInfo: L.t._("Enable this to export your level data in a secondary super simple format, ideal for quick integration in ANY existing engine. You will get: - one PNG per layer, - one composite PNG per level, - a single JSON file per level containing main level infos and entities."),
			learnMoreSimpleFormat: L.t._("Learn more about this format"),
			saveLevelsSeparateLabel: L.t._("Save levels to separate files"),
			saveLevelsSeparateInfo: L.t._("Enable this to separate the main project file (containing settings, definitions etc.) from the level files (one file per level, stored in a sub-folder). Saving times are also faster with separate levels enabled because unmodified data is cached and not re-wrote."),
			exportAsPngLabel: L.t._("Export as PNG"),
			exportAsPngInfo: L.t._("This option allows you to export 'flattened' PNG screenshots of the levels in addition to the JSON data, every time you save the project."),
			alsoExportBgLabel: L.t._("Also export level backgrounds"),
			alsoExportBgInfo: L.t._("Enable this to export PNGs that will include the level background color or image."),
			pngFileNamesLabel: L.t._("PNG file names"),
			exportTiledTmxLabel: L.t._("Export Tiled TMX"),
			exportTiledTmxInfo: L.t._("Enable this to create Tiled TMX files (one per level) in a sub folder, every time you save your project. Warning: this Tiled export is made for quick integration with game frameworks that don't support LDtk yet, but it comes with some limitations! See the link for more info."),
			learnMoreTiledLimitations: L.t._("Learn more about Tiled export limitations"),
			projectSettingsHeader: L.t._("Project settings"),
			useExtPrefix: L.t._("Use"),
			useExtSuffix: L.t._("extension"),
			useExtInfoPre: L.t._("If checked, the project file will use the official extension "),
			useExtInfoPost: L.t._(" instead of the standard \".json\". This setting is recommended for proper file identification and association on your system."),
			recommendedLabel: L.t._("(recommended)"),
			backupOnSaveLabel: L.t._("Backup on save"),
			backupOnSaveInfo: L.t._("Everytime you save your project, an extra backup copy will be created in a subfolder. Backups will obviously increase saving time and disk usage, but that's not a reason for not using them ;) Note: in case of a crash, a special backup will be created, even if this setting is disabled."),
			maxBackupFilesLabel: L.t._("Max backup files:"),
			...
			customCommandsInfo: L.t._("A list of custom commands that will be executed by LDtk in various situations. The working directory for all these commands is the project directory. If multiple commands are to be ran at a given moment (eg. before saving), they will be executed in order of appearance here."),
			trustedMsg: L.t._("This project is allowed to run user commands on your computer."),
			removeAuthLink: L.t._("Remove authorization"),
			untrustedMsg: L.t._("This project is NOT allowed to run user commands on your computer."),
			unblockLink: L.t._("Unblock it"),
			workspaceSettingsHeader: L.t._("Workspace settings"),
			defaultLayerGridLabel: L.t._("Default layer grid"),
			defaultLayerGridInfo: L.t._("Set the default grid size when creating new layers in this project."),
			defaultEntitySizeLabel: L.t._("Default entity size"),
			defaultEntitySizeInfo: L.t._("Set the default width/height when creating new entities in this project."),
			defaultLevelIdsLabel: L.t._("Default level identifiers"),
			defaultLevelIdsInfo: L.t._("You can customize the default naming convention for all level identifiers. Note that level identifiers must be UNIQUE and as such, an extra auto-increment might be added to levels sharing getting the same name, to avoid collisions. Also, remember the identifiers should only contain letters, numbers, \"-\" and \"_\"."),
			workspaceBgColorLabel: L.t._("Workspace background color"),
			workspaceBgColorInfo: L.t._("Base background color of the project workspace"),
			defaultLevelBgColorLabel: L.t._("Default level bg color"),
			defaultLevelBgColorInfo: L.t._("Default background color of all levels."),
			defaultPivotLabel: L.t._("Default pivot point for new entities"),
			defaultPivotInfo: L.t._("Default entity pivot point position for all entities. See the Entity panel for more information about the pivot point."),
			advancedCollapser: L.t._("Advanced project settings"),
			advancedHelpText: L.t._("Advanced options are not recommended for most users as they might break compatibility with older game APIs. Please make sure you know what you're doing before using any of them!"),
			tutorialDescLabel: L.t._("Tutorial description"),
			tutorialDescInfo: L.t._("This optional description is displayed in a permanent banner on top of LDtk while this project is open. It is mainly used in LDtk sample maps to provide extra explanations of provided examples."),
		});
